...
def graphTest():
    ...
    g.add((HK['Damper_1'], BF['hasPart'], HK['Chiller_Temp_12']))
    ...
    g.add((HK['Damper_2'], BF['hasPart'], HK['Chiller_Temp_22']))
    ...
    g.add((HK['Chiller_3'], BF['hasPart'], HK['Chiller_Temp_32']))
    ...
    g.add((HK['AHU_1'], BF['hasPart'], HK['AHU_Flow_11']))
    ...
    g.add((HK['AHU_2'], BF['hasPart'], HK['AHU_Flow_21']))
    ...
    g.add((HK['VAV_1'], BF['hasPart'], HK['VAV_Flow_11']))
    ...
    g.add((HK['VAV_2'], BF['hasPart'], HK['VAV_Flow_21']))
